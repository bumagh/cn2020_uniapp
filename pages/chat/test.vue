				...
				<view class="row" v-for="(row,index) in msgList" :key="index" :id="'msg'+row.msg.id">
					...
					<block v-if="row.type=='user'">
						...
						<view class="my" v-if="row.msg.userinfo.uid==socketAuth.uid">
							...
							<view class="left">
								<!-- 文字消息 -->
								<view v-if="row.msg.tag=='text'" class="bubble">
	...
	export default {
		...
		*/
		methods:{
			...
			// 加载初始页面消息
			getMsgList(){
				//this.msgList = [{type:"user",msg:{content: "<div style=\"display: flex;align-items: center;word-wrap:break-word;\">808080</div>",created_at: "2023-01-05 10:54:40",fid: "60",id: "7",tag:"text",uid:"80",userinfo:{avatar:"/images/default.png",name:"会员30770435",uid:"80"}}}];
